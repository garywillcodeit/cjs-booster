...
/**
 * Get the lower value from an array.
 * @param {Array<Object>} array - The array to check.
 * @param {string} prop - The value or property to get.
 * @returns {Array<*>} - The found value or object with the lower value or higher property's value.
  ...
  try {
    ...
    array.forEach((e, i) => {
      if (i === 0 && typeof e === "number") {
        ...
        throw new Error(
          `"mixValue"'s parameter must be an array of numbers or an array of objects.`
        );
      }
    });
